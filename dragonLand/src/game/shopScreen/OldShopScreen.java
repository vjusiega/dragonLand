 ...
 * */
public abstract class OldShopScreen extends ClickableScreen {
	...
	public OldShopScreen(int width, int height) {
		super(width, height);
		update();
}
	
	public OldShopScreen(int width, int height, /*ArrayList<Dragon> dl,*/ Action act) {
		super(width, height);
		//dragonList = dl;
		action = act;
		update();
